...
export function wasm_auto_resize() {
    const ret = wasm.wasm_auto_resize();
    if (ret[1]) {
 ...
 * @returns {Uint8Array}
 */
export function wasm_resize(data, src_width, src_height, dst_width, dst_height, r) {
    const ptr0 = passArray8ToWasm0(data, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.wasm_resize(ptr0, len0, src_width, src_height, dst_width, dst_height, r);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('image_editor_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
